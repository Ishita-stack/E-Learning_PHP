      ...
      <div class="container py-5">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="rounded overflow-hidden mb-2">
               <!-- <img class="img-fluid" src="img/java_thumb.jpg" height="100px" /> -->
               <!-- <iframe src="abc.mp4?autoplay=0" height="200px"width="350px" autoplay="0"></iframe> -->
               <video height="100%" width="100%" controls poster="img/c_language.jpg">
                 <source src="abc.mp4">
               </video>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="rounded overflow-hidden mb-2">
              ...
              <video height="100%" width="100%" poster="img/c_language.jpg" controls>
                 <source src="pqr.mp4">
               </video>
              <div class="bg-secondary p-4" style="margin-top: -6px;">
                <div class="d-flex justify-content-between mb-3">
