      ...
      <div class="container py-5">
        <div class="row">
          ...
          <div class="col-lg-4 mt-5 mt-lg-0">
            <!-- Author Bio -->
            <div
              class="d-flex flex-column text-center bg-dark rounded mb-5 py-5 px-4" style="height: 419px;"
            >
              <img
                src="img/user.jpg"
        ...
        <div class="col-lg-5 col-md-12 mb-5">
          ...
          <div class="w-100">
            <div class="input-group">
              ...
              />
              <div class="input-group-append">
                <button class="btn btn-primary px-4" style="background-color:#006e72;color: white;border-color: #006e72;">Sign Up</button>
              </div>
            </div>
          </div>
        </div>
