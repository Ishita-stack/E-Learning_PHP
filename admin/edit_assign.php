<?php
    ...
    if (isset($_POST['update'])) 
    {
        ...
        if ($file_upload=true) 
        {
            ...
            {  
                $sql2="UPDATE `tbl_assignment` SET `c_title` = '$course', `a_title` = '$a_title', `a_thumbnail` = '$path1', `a_file` = '$path2' WHERE `tbl_assignment`.`a_id` = $id;";
                $qry=mysqli_query($con,$sql2);
                echo "<script>alert('Data Updated successfully');</script>";
            }
            else if (!(move_uploaded_file($_FILES['file1']['tmp_name'],$path1) and move_uploaded_file($_FILES['file2']['tmp_name'],$path2)))
            {    
                $sql2="UPDATE `tbl_assignment` SET `c_title` = '$course', `a_title` = '$a_title' WHERE `tbl_assignment`.`a_id` = $id;";
                $qry=mysqli_query($con,$sql2);
                echo "<script>alert('Data Updated successfully');</script>";
            }
        }
...
<body>
    <div class="side-menu">
        ...
        <div class="dropdown-container" style="padding:10px">
            ...
            <a href="add_courses.php?status=add courses" class="<?php 
            error_reporting(0);
            if ($_GET['status']=='add courses') 
            {
                echo 'active';
            }
            ?>" style="padding:15px;"><i class="uil uil-plus-circle"></i>&nbsp Add Courses</a>

            <br><br></div>
            <div id="inner_div2">
            <a href="manage_courses.php?status=manage courses" class="<?php 
            error_reporting(0);
            if ($_GET['status']=='manage courses') 
            {
                echo 'active';
            }
            ?>" style="padding:15px;"><i class="uil uil-cog"></i>&nbsp Manage Courses</a><br></div>
        </div>
        ...
        <div class="dropdown-container" style="padding:10px">
            <div id="inner_div1">
            <a href="add_courses.php" style="padding:15px;"><i class="uil uil-plus-circle"></i>&nbsp; Add Videos</a><br><br></div>
            <div id="inner_div2">
            <a href="manage_courses.php" style="padding:15px;"><i class="uil uil-cog"></i>&nbsp; Manage Videos</a><br></div>
        </div>
        ...
        <div class="dropdown-container" style="padding:10px">
            <div id="inner_div1">
            <a href="add_assignment.php" style="padding:15px;"><i class="uil uil-plus-circle"></i>&nbsp Add Assign</a><br><br></div>
            <div id="inner_div2">
            <a href="manage_assign.php" style="padding:15px;"><i class="uil uil-cog"></i>&nbsp Manage Assign</a><br></div>
        </div>
         ...
         <div class="content">
            ...
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;">Edit Assignments&nbsp;<i class="uil uil-book-open"></i></h1>
                        ...
                        <div style="width: 750px;height: 350px;margin:auto;padding:20px;border-radius: 10px;">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <?php 
                                    ...
                                    echo '<div>
                                            <input type="text" name="assigntitle" value="'.$row['a_title'].'" style="width:710px;color:gray;">
                                        </div><br>';
                              
                              ?>
                                <div style="">
                                  <label for="input-file1" style="cursor: pointer;">
                                  <div style="border: 2px dashed #006e72;width: 350px;height: 100px;text-align: center;padding: 20px;">
                                ...
                                <div style="">
                                  ...
                                  <div style="border: 2px dashed #006e72;width: 350px;height: 100px;text-align: center;padding: 20px; float: right;margin-top: -100px;">
                                      <i class="uil uil-file-upload" style="font-size:40px;color: #006e72;"></i>
                                      <p id="txt2" style="color: #006e72;">Click here to Upload Assignment File </p>
                                  </div>
                                  </label>
                            ...
                            function abc1(){
                                var d=document.querySelector("#input-file1");
                                 ...
                                 txt1.innerHTML=d.value;
                            }
                             function abc2(){
                                var d=document.querySelector("#input-file2");
                                 var txt2=document.querySelector("#txt2");
                                 txt2.innerHTML=d.value;   
                            }
                        </script>
                            
                        </div>
                    <div>
                        <input type="submit" name="update" class="submit_btn" value="Edit Assignment">
                    </div>
                    </form>
                    </div>
                </div>
