...
<style type="text/css">
    ...
    .inputfields
    {
        height: 40px;width:800px;padding: 15px;border: 2px solid #006e72;outline: none;border-radius: 3px;
        color: gray;
    }
    #div1,#div2 label
    {
         ...
         <div class="content">
            ...
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;"><i class="uil uil-envelope-upload"></i> Send Mail</h1>
                    </div>
                ...
                <?php 
                    ...
                    echo '<div style="padding-top: 50px;padding-left: 50px;">
                        ...
                        <div style="margin-left: 130px;">
                            <div>
                                <input type="text" name="sender" placeholder="To" value="'.$row['s_email'].'" class="inputfields">
                            </div><br>
                            <div>
                                <input type="text" name="receiver" placeholder="issharma479@gmail.com" value="issharma479@gmail.com" class="inputfields">
                            </div><br>
                            <div>
                                <input type="text" name="sub" placeholder="Subject"class="inputfields">
                            </div>
                        </div><br>
                        <div style="padding-right: 3px;">

                            <textarea rows="4" cols="20" name="msg" placeholder="Message" style="margin-left:130px;border: 2px solid #006e72;border-radius: 3px;width: 800px;outline: none;padding: 20px;"></textarea>
                        </div>
                    <div>
                        <input type="submit" name="submit" class="submit_btn" value="Send Mail">
                    </div>
                    </div>';
                ?>
                    </form>
