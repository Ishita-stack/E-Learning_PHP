         ...
         <div class="content" style="">
            ...
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;"><i class="uil uil-book-open"></i> Manage Courses</h1>
...
<?php 
    // $con=mysqli_connect("localhost","root","","online_education")or die('connetion error');
    // $sql="SELECT * FROM `tbl_course` where c_id<=4;";
    ...
    while ($row=mysqli_fetch_assoc($run)) {
            $id=$row['c_id'];
            $uurl1='del_courses.php?id='.$id; 
            $uurl2='edit_courses.php?id='.$id; 
                echo '
                    <div class="card_div" style="background-color: ">
                        <div class="card" style="width: 320px" >
                            <img src="'.$row['c_thumbnail'].'" alt="Avatar" style="width:100%;margin-left: 0px;border-top-right-radius: 10px;
                              border-top-left-radius: 10px;">
                            <div class="description">
                                <h2 style="color:#006e72"><b>'.$row['c_title'].'</b></h2><p style="float:right;margin-top: -25px;font-size: 20px;">₹'.$row['c_price'].'</p> <br>
                                <p style="font-size: 20px;">'.$row['c_des'].'</p> 
                                <div style="margin-top: 20px;
                                margin-left: 90px;">
                                <a onclick="edit_rec('."'".$uurl2."'".')" class="btn" style="height:25px;">Edit</a>&nbsp
                                <a onclick="delete_rec('."'".$uurl1."'".')" class="btn" style="height:25px;">Delete</a>
                                </div>
                            </div>
                        </div>
                        </div>';
