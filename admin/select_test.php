<?php
    ...
    // $sqlnew="SELECT DISTINCT(t_title) FROM `tbl_test` WHERE `c_title`='$ctitle' ORDER BY t_title;";
    // $qrynew=mysqli_query($con,$sqlnew);
    // $row=mysqli_fetch_assoc($qrynew);
    // $sub=$row['c_title'];
    $results_per_page = 3;  
    $query = "SELECT DISTINCT(t_title) FROM `tbl_test` WHERE `c_title`='$ctitle' ORDER BY t_title;";  
    ...
    $query = "SELECT DISTINCT(t_title) FROM `tbl_test` WHERE `c_title`='$ctitle' ORDER BY t_title LIMIT " . $page_first_result . ',' . $results_per_page;  
         ...
         <br><br>
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;"><i class="uil uil-file-edit-alt"></i> Select Test</h1>
                    </div>
                    <div class="alltest">
                        ...
                        <?php 
                            ...
                            while($row=mysqli_fetch_assoc($run))
                            {
                                ...
                                <div class="button_manage">
                                    ...
                                    <a href="test.php?id='.$row['id'].'" class="btn">View</a>
                                    <a href="add_quiz.php?t_title='.$row['t_title'].'" class="btn">Add</a>
                                </div>
                                </div><br>';
                            }
                        ?>
            ...
            <section class="pagination" style="margin-top: 200px;margin-left: 400px;">
              ...
              <?php 
                ...
                if ($_GET['page']>1) {
                    // code...
                $less=$_GET['page']-1;
                            echo ' <a href="select_test.php?page='.$less.'"><button id="pg-button-prev" type="button" class="pagination__button">
                <i class="fa fa-chevron-left"></i>
              </button></a>';
...
<a href="select_test.php?page='.$page.'"> 
<li class="pagination__item pagination__item--4">
                ...
                if ($_GET['page']<$number_of_page) 
                {
                    ...
                    $less=$_GET['page']+1;
                        ...
                        echo '<a href="select_test.php?page='.$less.'"><button id="pg-button-next" type="button" class="pagination__button">
