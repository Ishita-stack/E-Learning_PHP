         ...
         <div class="content">
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;"><i class="uil uil-file-edit-alt"></i> Add Test</h1>
                    </div>
                    ...
                    <div id="add_quiz" style="padding:50px;margin-left: 70px;">
                        ...
                        <input type="text" name="Test_Title" placeholder="Test Title" class="inputfields" style=""><br>
                        ...
                        <input type="submit" name="submit" value="Add Test" style="margin-left: 450px;margin-top: 20px;background-color: #006e72;border-radius: 5px;color: white;cursor: pointer;border:none;outline: none;padding: 10px;">
