...
<body>
        ...
        <div class="header" style="width:1227px">
            <div class="nav">
                ...
                <div class="user">
                    ...
                    <div class="img-case" style="margin-right: 40px;">
                       <?php
         ...
         <div class="content">
            ...
            <div class="content-2" style="margin-bottom: -200px;">
                ...
                while($row=mysqli_fetch_assoc($qry))
                {
                    ...
                    <div class="row">
                      <div class="column" >
                      <a href="all_test.php?c_title='.$row['c_title'].'" >
                                            <div class="card_div" >
  ...
  <a href="all_test.php" >
                        <div class="card_div" >
                        <div  style="background-color:none" >
                            <img src="images/cpp_thumb.jpg" alt="Avatar" style="width:30vh;margin-left: 0px;border-top-right-radius: 10px;
          border-top-left-radius: 10px;">
                            <div class="description" style="width:30vh;">
