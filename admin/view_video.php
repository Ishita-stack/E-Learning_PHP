         ...
         <div class="content">
            ...
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;"><i class="uil uil-play-circle"></i> View Video</h1>
                    </div>
                    <?php 
                        ...
                        $qry=mysqli_query($con,$sql)or die('query error');
                        $row=mysqli_fetch_assoc($qry);
                        echo '<div class="row justify-content-center" style="background-color:white;margin-left: 250px;margin-top: 70px;margin-bottom: 70px;">

                            <iframe src="'.$row['v_file'].'" width="690px" height="390px" style="background-color: white;padding-right: -20px;padding-left: -20px;border: none;">
                            </iframe>
