<?php
    ...
    $query = "SELECT * FROM `tbl_assignment` LIMIT " . $page_first_result . ',' . $results_per_page;  
         ...
         <div class="content">
            ...
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;"><i class="uil uil-book-open"></i> Manage Assignments</h1>
                    ...
                    <?php
                        ...
                        echo '<table style="margin-left: 90px;">
                                    <tr>
                                        <th>Thumbnails</th>
                                        <th style="padding-left: 65px;">Assignment Title</th>
                                        <th>Assignment Type</th>
                                        <th>Course</th>
                                        <th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspOptions</th>
                                    </tr>';
                        ...
                        while($row=mysqli_fetch_assoc($run))
                        {
                            ...
                            echo "<tr>";
                            echo "<td class='img-td'><img src='".$row['a_thumbnail']."' height='45px'width='45px'></td>&nbsp;";
                            
                            echo "<td style='padding-left: 65px;'>".$row['a_title']."</td>";
                            echo "<td>document/pdf</td>";
                            echo "<td>".$row['c_title']."</td>";
                            echo "<td><a href='view_assign.php?id=".$row['a_id']."' class='btn'>View</a>&nbsp<a href='edit_assign.php?id=".$row['a_id']."' class='btn'>Edit</a>&nbsp<a href='del_assign.php?id=".$row['a_id']."' class='btn'>Delete</a></td>";
                            echo "</tr>";
                        }
                        echo '<table>';
                    ?>
            ...
            <section class="pagination" style="margin-top: 50px;margin-left: 400px;">
              <?php 

                if ($_GET['page']>1) {
                    // code...
                $less=$_GET['page']-1;
                            echo ' <a href="manage_assign.php?page='.$less.'"><button id="pg-button-prev" type="button" class="pagination__button">
...
<a href="manage_assign.php?page='.$page.'"> 
<li class="pagination__item pagination__item--4">
                ...
                if ($_GET['page']<$number_of_page) 
                {
                    ...
                    $less=$_GET['page']+1;
                        ...
                        echo '<a href="manage_assign.php?page='.$less.'"><button id="pg-button-next" type="button" class="pagination__button">
