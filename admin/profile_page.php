         ...
         <div class="content">
            ...
            <div class="content-2">
                ...
                <?php   
                    ...
                    echo '<div id="div1">
                        <div id="inner_div1">
                            <img src="../login/form/'.$row['s_photo'].'"style="width: 100%;height: 100%;margin-left: 0px;">
                        </div><br>
                        ...
                        <div style="color: #006e72;font-size: 20px;font-weight: bolder;padding-left: 25px;padding:10px;">
                                ...
                                <div style="color: gray;font-weight: normal;font-size: 15px;margin-top: 5px;float: right;margin-right: 15px;">
                                    '.$row['s_email'].'
                                </div>
                        </div>
                        ...
                        <div style="color: #006e72;font-size: 20px;font-weight: bolder;padding-left: 25px;padding:10px;">
                                ...
                                <div style="color: gray;font-weight: normal;font-size: 15px;margin-top: 5px;float: right;margin-right: 128px;">
                                    '.$row['s_add'].'
                                </div>
                        </div>
                        ...
                        <div style="color: #006e72;font-size: 20px;font-weight: bolder;padding-left: 25px;padding:10px;">
                                ...
                                <div style="color: gray;font-weight: normal;font-size: 15px;margin-top: 5px;float: right;margin-right: 108px;">
                                    '.$row['s_dob'].'
                                </div>
                        </div>
