<?php
    ...
    if (isset($_POST['submit'])) 
    {
       ...
       {
            $sql="INSERT INTO `tbl_video` (`c_title`, `v_title`, `v_file`) VALUES ('$course', '$v_title ', '$path');";
         ...
         <div class="content">
            ...
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;"><i class="uil uil-play-circle"></i> Add Videos</h1>
                    ...
                    <div style="padding-top: 50px;">
                        <div style="width: 750px;height: 350px;margin:auto;padding:20px;border-radius: 10px;">
                            <form action="" method="post" enctype="multipart/form-data">
                              ...
                              <div>
                                  <input type="text" name="v_title"placeholder="Video Title" style="width:710px">
                              </div><br>
                              <div style="">
