<?php
    ...
    $results_per_page = 6;  
    $query = "SELECT * FROM `tbl_reg` where status=0 and role='user';";  
    ...
    $query = "SELECT * FROM `tbl_reg` where status=0 and role='user' LIMIT " . $page_first_result . ',' . $results_per_page;  
         ...
         <br><br>
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;"><i class="uil uil-user-circle"></i> User Requests</h1>
                    </div>
                    <?php 
                        
                        // $sql="SELECT * FROM `tbl_reg` where role='user' and status='0';";
                        ...
                        while ($row=mysqli_fetch_assoc($run)) 
                        {
                            ...
                            echo "<td><a href='allow.php?id=".$row['s_id']."'class='btn'>Allow</a>&nbsp<a href='#' class='btn'>Deny</a></td>";
                            echo "</tr>";
             ...
             <!--  <button id="pg-button-prev" type="button" class="pagination__button">
              ...
              <?php 
                ...
                $less=$_GET['page']-1;
                        ...
                        echo '<a href="request_user.php?page='.$less.'"><button id="pg-button-prev" type="button" class="pagination__button">
                <i class="fa fa-chevron-left"></i>
              </button></a>';
              ...
              // </button></a>';
                ...
                {  
                    echo '<a href="request_user.php?page='.$page.'"><li class="pagination__item pagination__item--1">
                ...
                if ($_GET['page']<$number_of_page) 
                {
                    ...
                    echo '<a href="request_user.php"><button id="pg-button-next" type="button" class="pagination__button">
                <i class="fa fa-chevron-right"></i>
              </button></a>';
