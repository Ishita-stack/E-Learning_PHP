<?php
    ...
    $id=$_GET['id'];
    $sql_new="SELECT * FROM `tbl_video` WHERE v_id=$id;";
    $qry_new=mysqli_query($con,$sql_new);
    $row_new=mysqli_fetch_assoc($qry_new);
    $old_path=$row_new['v_file'];
    ...
    if (isset($_POST['update'])) 
    {
        ...
        if (move_uploaded_file($_FILES['file1']['tmp_name'],$path1)) 
        {
            ...
            $sql2="UPDATE `tbl_video` SET `c_title` = '$c_title', `v_title` = '$v_title', `v_file` = '$path1' WHERE `tbl_video`.`v_id` = $id;";
         ...
         <div class="content">
            ...
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;"><i class="uil uil-play-circle"></i>&nbsp;Edit Video</h1>
                        ...
                        <div style="width: 750px;height: 350px;margin:auto;padding:20px;border-radius: 10px;">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <?php 
                                    ...
                                    $sql="SELECT * FROM `tbl_video` WHERE v_id=$id;";
                                    ...
                                    echo '<select id="option_id" name="c_title">';
                                    ...
                                    echo '<div>
                                            <input type="text" name="v_title" value="'.$row['v_title'].'" style="width:710px;color:gray;">
                                        </div><br>';
                              
                              ?>
                                <div style="">
                                  <label for="input-file1" style="cursor: pointer;">
                                  <div style="border: 2px dashed #006e72;width: 710px;height: 100px;text-align: center;padding: 20px;">
                                      <i class="uil uil-file-upload" style="font-size:40px;color: #006e72;"></i>
                                      <p id="txt1" style="color: #006e72;">Click here to Upload file</p>
                                  </div>
                                  </label>
                    ...
                    <div>
                        <input type="submit" name="update" class="submit_btn" value="Edit Video">
                    </div>
                    </form>
                    </div>
                </div>
