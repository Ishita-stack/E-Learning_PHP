<?php
    ...
    $ctitle=$_SESSION['course'];
    $ttitle=$_GET['t_title'];
    if (isset($_POST['submit'])) 
    {
       
        $course=$_POST['course'];
        $Test_Title=$_POST['t_title'];
        $que=$_POST['que'];
        $a=$_POST['opt1'];
        $b=$_POST['opt2'];
        $c=$_POST['opt3'];
        ...
        $correct=$_POST['radio'];
        echo $correct;
        $sql="INSERT INTO `tbl_test` (`t_title`, `t_que`, `t_ans`, `t_a`, `t_b`, `t_c`, `t_d`, `c_title`, `t_id`) VALUES ('$Test_Title','$que','$correct','$a', '$b', '$c', '$d','$course', '102');";
         ...
         <div class="content">
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;"><i class="uil uil-file-edit-alt"></i> Add Quiz</h1>
                    </div>
                    ...
                    <div id="add_quiz" style="padding:50px;margin-left: 70px;">
                         <div>
                                <?php 
                                    ...
                                    echo '<input type="text" name="course" placeholder="Test Title" class="inputfields" style="" value="'.$ctitle.'" readonly><br> ';
                               
                                
                              echo '</div>
                        <input type="text" name="t_title" placeholder="Test_title" class="inputfields" style="" value="'.$ttitle.'" readonly><br>';
                        ?>
                        <textarea rows="10" cols="50" class="inputfields" name="que" placeholder="Add Question" style=" margin-left:150px;
                            ...
                            outline: none;
                            border-radius: 3px;
                            margin-top: 10px;height: 100px;"></textarea>
                        <div class="inputfields" style="height:260px">
                            ...
                            <label class="container1">
                              <input type="radio" checked="checked" value="a" name="radio">
                              <span class="checkmark"></span>
                            </label>
                            <input type="text" name="opt1"style="border: none;outline: none;border-bottom: 2px solid #006e72;padding-left: 10px;margin-left: 30px;"><br><br><br>
                            <label class="container1">
                              <input type="radio" value="b" name="radio">
                              <span class="checkmark"></span>
                            </label>
                            <input type="text" name="opt2"style="border: none;outline: none;border-bottom: 2px solid #006e72;padding-left: 10px;margin-left: 30px;"><br><br><br>
                            <label class="container1">
                              <input type="radio" value="c" name="radio">
                              <span class="checkmark"></span>
                            </label>
                            <input type="text" name="opt3"style="border: none;outline: none;border-bottom: 2px solid #006e72;padding-left: 10px;margin-left: 30px;"><br><br><br>
                            <label class="container1">
                              <input type="radio" value="d" name="radio">
                              <span class="checkmark"></span>
                            </label>
                            <input type="text" name="opt4"style="border: none;outline: none;border-bottom: 2px solid #006e72;padding-left: 10px;margin-left: 30px;"> 
                            </div>
                        </div>
                        <input type="submit" name="submit" value="Add Quiz" style="margin-left: 450px;margin-top: 20px;background-color: #006e72;border-radius: 5px;color: white;cursor: pointer;border:none;outline: none;padding: 10px;">
                        <!-- <input type="submit" name="submit" value="Add New Test" style="margin-left: 0px;margin-top: 20px;background-color: #006e72;border-radius: 5px;color: white;cursor: pointer;border:none;outline: none;padding: 10px;"> -->
                    </div>
                </form>
                </div>
            </div>
