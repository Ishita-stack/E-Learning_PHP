<?php
   ...
   $_SESSION['c_title']=$c_title;
    $results_per_page = 3;  
    $query = "SELECT DISTINCT(t_title) FROM `tbl_test` WHERE `c_title`='$c_title' ORDER BY t_title;";  
    ...
    $query = "SELECT DISTINCT(t_title) FROM `tbl_test` WHERE `c_title`='$c_title' ORDER BY t_title LIMIT " . $page_first_result . ',' . $results_per_page;  
         ...
         <br><br>
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;"><i class="uil uil-file-edit-alt"></i>Manage Test</h1>
                    </div>
                    <div class="alltest">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <?php 
                            ...
                            $sql="SELECT DISTINCT(t_title) FROM `tbl_test` WHERE `c_title`='$c_title' ORDER BY t_title";
                            $qry=mysqli_query($con,$sql)or die('query error');
                            ;

                            while($row=mysqli_fetch_assoc($run))
                            {
                                $_SESSION['c_sub']=$c_title;
                                $sql2="SELECT * FROM `tbl_course` WHERE c_title='$c_title';";
                                $qry2=mysqli_query($con,$sql2);
                                $row2=mysqli_fetch_assoc($qry2);

                                echo '<div class="inner_test">
                                <div class="test_img">
                                    <img src="'.$row2['c_thumbnail'].'">
                                </div>
                                ...
                                <div class="button_manage">
                                    ...
                                    <a href="test.php?t_title='.$row['t_title'].'" class="btn">View</a>
                                    <a href="edit_test_new.php?t_title='.$row['t_title'].'" class="btn">Edit</a>
                                    <a href="del_test.php?t_title='.$row['t_title'].'" class="btn">Delete</a>
                                </div>
                                </div><br>';
                            }
                        ?>
            ...
            <section class="pagination" style="margin-top: 200px;margin-left: 400px;">
              ...
              <?php 
                ...
                if ($_GET['page']>1) {
                    // code...
                $less=$_GET['page']-1;
                            echo ' <a href="all_test.php?page='.$less.'"><button id="pg-button-prev" type="button" class="pagination__button">
...
<li class="pagination__item pagination__item--4">
                ...
                if ($_GET['page']<$number_of_page) 
                {
                    ...
                    $less=$_GET['page']+1;
                        ...
                        echo '<a href="all_test.php?page='.$less.'"><button id="pg-button-next" type="button" class="pagination__button">
