         ...
         <div class="content">
            ...
            <div class="content-2" style="margin-bottom: -200px;">
                ...
                <?php 
                    ...
                    echo '<tr>
                                <th style="margin-left: 50px;">No.</th>
                                <th style="margin-left: 50px;">Courses</th>
                                <th>Amount</th>
                                <th >Options</th>
                            </tr>'; 
                            $count=1;
                    while($row=mysqli_fetch_assoc($qry))
                    {
                         ...
                         echo '<tr>
                                ...
                                <td>'.$row['s_sub'].'</td>
                                <td>'.$row['c_price'].'</td>
                                <td><a href="vaoucher/receipt.php?id='.$row['p_id'].'" class="btn">Receipt</a></td>
                            </tr>';
                            $count++;
                    }
                        ...
                        //     <td>₹120</td>
                        //     <td>12-Mar-20</td>
                        //     <td><a href="vaoucher/receipt.php" class="btn">Receipt</a>
                        // </tr>
                        // <tr>
                        //     <td>3.</td>
