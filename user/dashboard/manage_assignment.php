...
<body>
 ...
 <body>
         ...
         <div class="content">
            ...
            <div class="content-2" style="margin-bottom: -200px;">
                ...
                <div class="div1">
                    ...
                    $sql1="SELECT * FROM `tbl_payment_info` WHERE s_name='$name';";
                    ...
                    while($row1=mysqli_fetch_assoc($qry1))
                    {
                      ...
                      <a href="all_assignment.php?id='.$row3['c_id'].'" >
                                            <div class="card_div" >
                              ...
                              border-top-left-radius: 10px;">
                                                <div class="description" style="width:30vh;">
                                                    <h3 style="color:#006e72"><b>'.$row3['c_title'].'</b></h3><p style="float:right;margin-top: -17px;font-size: 15px;">₹'.$row3['c_price'].'</p> <br>
    ...
    <section class="pagination" style="margin-top: 750px;margin-left: -400px;position: relative;right: 400px;">
