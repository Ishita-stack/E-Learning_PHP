    ...
    <div class="container">
        <div class="header" style="width:1227px">
         ...
         <div class="content">
            <br><br>
            <?php
            $sqlnew="SELECT * FROM `tbl_assignment` WHERE a_id='$id';";
            $qrynew=mysqli_query($con,$sqlnew);
            $rownew=mysqli_fetch_assoc($qrynew);
            echo '<div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;">View Assignments</h1>
                    </div>
                    <embed src="../../admin/'.$rownew['a_file'].'" type="application/pdf" height="600vh" width="100%">
                </div>';
                ?>
            </div>
        </div>
