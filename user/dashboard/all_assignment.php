<?php
    ...
    $id=$_GET['id'];
    $sql2="SELECT * FROM `tbl_course` WHERE c_id=$id;";
         ...
         <div class="content">
            ...
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;"><i class="uil uil-file-edit-alt"></i> All Assignments</h1>
                    </div>
                <?php
                    echo '</br></br>';
                    $sql1="SELECT * FROM `tbl_assignment` WHERE c_title='$sub' ORDER BY a_title;";
                    $qry1=mysqli_query($con,$sql1);
                    
                    while($row1=mysqli_fetch_assoc($qry1))
                    {
                       
                        echo  '<div class="inner_test" style="margin:auto;margin-top:20px">
                            <div class="test_img">
                                <img src="../../admin/'.$row1['a_thumbnail'].'">
                            </div>
                            <div class="test_title">
                                '.$row1['a_title'].'
                            </div>
                            <div class="button_manage">
                                <a href="view_assign.php?id='.$row1['a_id'].'" class="btn">Read</a>
