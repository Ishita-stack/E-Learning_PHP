         ...
         <div class="content">
            ...
            <div class="content-2" style="margin-bottom: -200px;">
                <div class="recent-payments">
                    <div class="title">
                        <h1 style="color:#006e72;margin: auto;"><i class="uil uil-forward"></i> Active Courses</h1>
                    </div>
                    <div class="div1"style="margin-top: 20px;">
                       

                    <!-- <a href="../video/course_detail_view.php"> -->
...
<!-- card start -->
          ...
          border-top-left-radius: 10px;">
                            <div class="description">
                                <h3 style="color:#006e72"><b>'.$row1['s_sub'].'</b></h3><br>
...
<!-- card start --><!-- 
          ...
          border-top-left-radius: 10px;">
                            <div class="description">
                                ...
                                <div class="box-progress-wrapper" style="margin-top:10px">
          <p class="box-progress-header"><b>Progress:</b></p><p class="box-progress-percentage" style="float:right;margin-top: -11px;margin-right: 115px;">30%</p>
          <div class="box-progress-bar" style="margin-top:5px;border: 2px solid #006e72;padding: 1px;border-radius: 5px;">
            <span class="box-progress" style="width: 30%; background-color: #006e72"></span>
          </div>
