<?php
    ...
    if (isset($_POST['update']))
    {
        ...
        $path="upload/".$file;
        $upath="../../login/form/upload/".$file;
        if ($file_upload==true) 
        {
            
            if (move_uploaded_file($_FILES['file1']['tmp_name'],$upath)) 
            {
        ...
        else if ($file_upload==false)
        {
            if(!(move_uploaded_file($_FILES['file1']['tmp_name'],$upath)))
            {
                $sql1="UPDATE `tbl_reg` SET `s_name` = '$name', `s_gender` = '$gender', `s_phone` = '$phone', `s_dob` = '$dob', `s_add` = '$add', `s_profession` = '$profession', `s_email` = '$Email', `s_photo` = '$old_path', `password` = '$pass' WHERE `tbl_reg`.`s_id` = $id;";
                $qry1=mysqli_query($con,$sql1);
                if ($qry1) 
                {
                    $_SESSION['alert']=1;
...
/*      margin-left: 30px;*/
    ...
    .input_field
    {
        border:none;border-bottom: 2px solid #006e72;outline: none;padding-left: 3px;
    }
    .side-menu a .active
    {
        background-color: white;
    ...
    #inner_div1
    {
        width:150px;height:150px; margin: auto;margin-top: 10%; position: relative;
    }
                ...
                <div class="recent-payments" style="display:inline-block;">
                    ...
                    echo '<div style="border:2px solid white;float:right;width: 715px; height: 483px;position: relative;margin-top: -503px;margin-right: 20px;border-radius: 15px;box-shadow: 0 4px 8px 0 #006e7236, 0 6px 20px 0 rgba(0, 0, 0, 0.19);padding: 20px;">
                        ...
                        echo '<div style="float:right;margin-top: -285px;margin-right: 20px;">
                            ...
                            <div style="color: #006e72;font-size: 23px; display:flex;">
                                ...
                                if($gn=='male' or $gn=='Male')
                                {
                                    echo '<div class="container1">
                                          ...
                                          <div class="right" style="margin-left:10px;">Male &nbsp;</div>

                                          <div class="container1" style="position:relative;left:10px;">
                                            <div class="radio">
