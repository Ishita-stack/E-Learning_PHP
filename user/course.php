<?php 
    ...
    $query = "SELECT * FROM `tbl_course` LIMIT " . $page_first_result . ',' . $results_per_page;  
...
<html lang="en">
  ...
  <body>
   ...
   <div class="container-fluid" style="margin-top: 0px;">
        ...
        >
          ...
          > -->
            ...
            <span onclick="goto('index.php')" style="cursor: pointer;">
              <img src="img/logo3.png" height="100%" width="20%" style="margin-left: -12px; color: white; margin-top: 5px;">&nbsp;<span style=" color: white;padding-top: 12px;font-size: 30px;top:2px;position: absolute; font-weight: bolder;font-family: 'Poppins', sans-serif;"><b>Study Squad</b></span>
            </span>
        ...
        <div class="col-lg-9" style="background-color: #006e72;margin-top: -2px;">
          ...
          >
            ...
            <div
              ...
              id="navbarCollapse"
              style="background-color: #006e72;margin-left:-10px;margin-right: -10px;margin-bottom: -1px;"
            >

              <div class="navbar-nav py-0" style="position: relative;left: 540px;">
          ...
          elseif ($_GET['status']=='')
          {
            echo 'active';
                 ...
                 ?>" style="float:left;font-size: 18px;font-weight: 500;text-shadow: 1px 1px #006e72;font-family: 'Poppins', sans-serif;">Home</a>&nbsp
                <a href="course.php?status=Courses" class="nav-item nav-link <?php error_reporting(0);
          if ($_GET['status']=='Courses') 
          {
            echo 'active';
          }
                 ?>" style="float:left;font-size: 18px;font-weight: 500;text-shadow: 1px 1px #006e72;font-family: 'Poppins', sans-serif;">Courses</a>
          ...
          if ($_GET['status']=='About') 
          {
            echo 'active';
                 ...
                 ?>" style="float:left;font-size: 18px;font-weight: 500;text-shadow: 1px 1px #006e72;font-family: 'Poppins', sans-serif;">About</a>
                <!-- <div class="nav-item dropdown">
          ...
          if ($_GET['status']=='Contact') 
          {
            echo 'active';
                 ...
                 ?>" style="float:left;font-size: 18px;font-weight: 500;text-shadow: 1px 1px #006e72;font-family: 'Poppins', sans-serif;">Contact</a>
              </div>
               <?php 
                 if ($_SESSION['role']!='user') 
                 {
                    echo '<span onclick="goto()"
                    style="width:135px;color:#006e72;background-color:white;margin-left:565px;position:relative;top:23px;padding-left:28px;padding-right:28px;padding-top:10px;padding-bottom:10px;border-radius:8px;font-weight:400;font-size:16px;cursor:pointer;"
                    >Login Now</span>';
                 }
                ?> 
                <script type="text/javascript">
    ...
    <!-- Header Start -->
    <div class="container-fluid page-header" style="margin-bottom: -20px;margin-top: 0px;">
      <div class="container">
        <div
          class="d-flex flex-column justify-content-center"
          style="min-height: 300px;margin-top: -8px;"
        >
          <h3 class="display-4 text-white text-uppercase" style="font-size:55px;">Courses</h3>
          <div class="d-inline-flex text-white">
            <p class="m-0 text-uppercase">
              <a class="text-white" href="index.php" style="font-size: 16px;">Home</a>
            </p>
            <i class="fa fa-angle-double-right pt-1 px-3" style="margin-top:3px;"></i>
            <p class="m-0 text-uppercase" style="color:white; font-size: 16px;">Courses</p>
          </div>
        </div>
      </div>
    </div>
...
if ($_SESSION['role']=='user') {
 ...
 <div class="action" style="position: absolute;">
        ...
        <div class="menu" style="margin-top:-30px;padding:0px;padding-left:10px">
            <h3 style="margin-left:13px;margin-top:0px">
                User Account
                <div>
                    '.$uname.'
                </div>
...
<!-- course start -->
            <div class="container">
                ...
                $arr=array('');
            $sq="SELECT s_sub FROM tbl_payment_info where s_email='hetal@gmail.com' GROUP BY s_sub;";
...
if (in_array($row['c_title'], $arr)) {
              



                      echo '<div class="col-md-4 col-sm-12 col-xs-12 wow fadeIn">
                        <div class="shop-item course-v2">
                            <div class="post-media entry">
                                <img src="../admin/'.$row['c_thumbnail'].'" alt="" class="img-responsive" style="border-top-left-radius:10px;border-top-right-radius:10px;">
                                <div class="magnifier">
                                    <div class="shop-bottom clearfix"style="margin-top: -20px;">
                                        <!-- <a href="course-checkout.html" title="Add to Cart"><i class="fa fa-shopping-cart"></i></a> -->
                                        <a href="../login/login.php" title="Full Preview"><i class="uil uil-play-circle" style="font-size:40px"></i></a>
                                    </div><!-- end shop-bottom -->
                                </div><!-- end magnifier -->
                            </div><!-- end post-media -->
                            <div class="shop-desc">
                                
                                <h3><a href="video/course_detail_view.php?id='.$row['c_id'].'">'.$row['c_des'].'</a></h3>
                            </div>
                            <div class="shop-desc" style="border-bottom-left-radius: 10px;
    border-bottom-right-radius: 10px;">
                            <a href="video/course_detail_view.php?id='.$row['c_id'].'">
                                <input type="submit" name="submit" value="View" style="border:none;background-color:#006e72;width:90px;height:35px;border-radius:5px;color:white;font-weight:bolder;"></a>
                                <span style="font-size:17px;margin-left:170px;">₹'.$row['c_price'].'</span>
                            </div>
                        </div><!-- end shop-item -->
                      ...
                      echo '<div class="col-md-4 col-sm-12 col-xs-12 wow fadeIn">
                        <div class="shop-item course-v2">
                            ...
                            <div class="shop-desc">
                                ...
                                <h3><a href="../login/login.php" title="">'.$row['c_des'].'</a></h3>
                            </div>
                            <div class="shop-desc" style="border-bottom-left-radius: 10px;
    border-bottom-right-radius: 10px;">
                            <a href="../pay/payment.php?id='.$row['c_id'].'">
                                <input type="submit" name="submit" value="Buy Now" style="border:none;background-color:#006e72;width:90px;height:35px;border-radius:5px;color:white;font-weight:bolder;"></a>
                                <span style="font-size:17px;margin-left:170px;">₹'.$row['c_price'].'</span>
                            </div>
                        </div><!-- end shop-item -->
                    </div><!-- end carousel-item -->'; 
                    ...
                    else
                    {
                      echo '<div class="col-md-4 col-sm-12 col-xs-12 wow fadeIn">
                        <div class="shop-item course-v2">
                            ...
                            <div class="shop-desc" style="border-bottom-left-radius: 10px;
    border-bottom-right-radius: 10px;">
                            <a href="../login/login.php?id='.$row['c_id'].'">
                                <input type="submit" name="submit" value="Buy Now" style="border:none;background-color:#006e72;width:90px;height:35px;border-radius:5px;color:white;font-weight:bolder;"></a>
                                <span style="font-size:17px;margin-left:170px;">₹'.$row['c_price'].'</span>
                            </div>
                        </div><!-- end shop-item -->
                ...
                $less=$_GET['page']-1;
                          ...
                          echo '<li>
                        <a class="active" href="course.php?page='.$less.'" aria-label="Next">
                ...
                {  
                          echo '<li><a href="course.php?page='.$page.'">'.$page.'</a></li>';
                ...
                if ($_GET['page']<$number_of_page) 
                {
                    ...
                    $less=$_GET['page']+1;
                      ...
                      echo '<li>
                        <a href="course.php?page='.$less.'" aria-label="Next">
                        <span aria-hidden="true">>></span>
                        </a>
                        </li>';
    ...
    >
      <div class="row pt-5" style="background-color:#44425a;">
        <div class="col-lg-7 col-md-12">
          <div class="row">
            <div class="col-md-6 mb-5">
              ...
              <p style="color:white;"><i class="fa fa-phone-alt mr-2"></i>+91 8141633872</p>
              <p style="color:white;"><i class="fa fa-envelope mr-2"></i>studysquad@example.com</p>
              <div class="d-flex justify-content-start mt-4">
                <a class="btn btn-outline-light btn-square mr-2" style="border: 1px solid white;border-radius: 15px;" href="#"
                  ><i class="fab fa-twitter"></i
                ></a>
                <a class="btn btn-outline-light btn-square mr-2" style="border: 1px solid white;border-radius: 5px;" href="#"
                  ><i class="fab fa-facebook-f"></i
                ></a>
                <a class="btn btn-outline-light btn-square mr-2" style="border: 1px solid white;border-radius: 5px;" href="#"
                  ><i class="fab fa-linkedin-in"></i
                ></a>
                <a class="btn btn-outline-light btn-square" style="border: 1px solid white;border-radius: 5px;" href="#"
        ...
        <div class="col-lg-5 col-md-12 mb-5" style="margin-top:-40px">
