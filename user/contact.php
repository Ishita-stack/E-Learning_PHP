...
<!-- over user -->
    ...
    <input type="text" class="form-control" name="name" id="name" value="<?php echo $sname; ?>" placeholder="Name" readonly>
    </div>
    </div>
    <div class="col-md-6">
    <div class="form-group">
    <input type="email" class="form-control" name="email" id="email" value="<?php echo $semail; ?>" placeholder="Email" readonly>
    </div>
    </div>
    <div class="col-md-12">
    <div class="form-group">
