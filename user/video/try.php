...
<body>
	...
	<header class="header clearfix">
		...
		<div class="header_right">
			<ul>
				<li class="ui dropdown" style="margin-left:-50px">
						...
						<div class="channel_my">
							<div class="profile_link">
								...
								<div class="pd_content">
									<div class="rhte85">
										<h6><b>Ishita Sharma</b></h6>
										<div class="mef78" title="Verify">
											<i class='uil uil-check-circle'></i>
										</div>
									</div>
									<span>issharma479@gmail.com</span>
								</div>							
							</div>
						</div>
					...
					<div class="col-lg-12">
						<div class="section3125">							
							<div class="row justify-content-center" width="900px" height="600px" style="background-color:white;margin-top:30px">											
											<iframe src="abc.mp4" width="976px" height="549px" style="background-color: white;padding-right: -20px;padding-left: -20px;border: none;"></iframe>
										</a>							
							</div>							
						</div>							
					</div>															
							...
							<div class="tab-content" id="nav-tabContent">
								...
								<div class="tab-pane fade" id="nav-reviews" role="tabpanel">
									<div class="student_reviews">
										<div class="row">
											...
											<div class="col-lg-7">
												...
												<?php
													// $sqlnew="SELECT * FROM `tbl_comment`;";
													// $qrynew=mysqli_query($con,$sqlnew);
                								...
                								$less=$_GET['page']-1;
                								// echo '<li>
                								// <a class="active" href="course.php?page='.$less.'" aria-label="Next"></a>
                        				// </li>';

                        				echo '<li>
                        				<a class="active" href="course_detail_view.php?page='.$less.'"><i class="uil uil-angle-left"></i></a>
                        				</li>&nbsp;';
                							}
                							...
                							{  
                          			// echo '<li>
                          			// <a href="course.php?page='.$page.'">'.$page.'</a></li>';
                          			echo '<li>
                          			<a href="course.php?page='.$page.'">'.$page.'</a>
                          			</li>&nbsp;';
                          		} 
                          		...
                          		if ($_GET['page']<$number_of_page) 
                    						...
                    						$less=$_GET['page']+1;
		                        		echo '<li>
		                        		<a href="course.php?page='.$less.'"><i class="uil uil-angle-right"></i></a>
		                        		</li>&nbsp;';
                							}
