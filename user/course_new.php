...
if (in_array($row['c_title'], $arr)) {
    ...
    border-bottom-right-radius: 10px;">
                            <a href="../pay/payment.php?id='.$row['c_id'].'">
                                <input type="submit" name="submit" value="By Now" style="border:none;background-color:#006e72;width:90px;height:35px;border-radius:5px;color:white;font-weight:bolder;"></a>
                                <span style="font-size:17px;margin-left:170px;">₹'.$row['c_price'].'</span>
                            </div>
                        </div><!-- end shop-item -->
                    </div><!-- end carousel-item -->'; 
